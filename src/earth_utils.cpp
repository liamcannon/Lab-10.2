...
{
    string KML_OPEN_TAG = "<?xml version=\"1.o\" encoding=\"UTF-8\"?>\n"
                          "<kml xmlns=\"http://www.opengis.net/kml/2.2\" xmlns:gx=\"http://www.google.com/kml/ext/2.2\" xmlns:kml=\"http://www.opengis.net/kml/2.2\" xmlns:atom=\"http://www.w3.org/2005/Atom\">\n"
                          "<Document>\n";
    string KML_CLOSE_TAG = "</Document>\n</kml>";
    string PLACEMARK_OPEN_TAG = "<Placemark>\n";
    string PLACEMARK_CLOSE_TAG = "</Placemark>\n";
    string NAME_OPEN_TAG = "<name>\n";
    string NAME_CLOSE_TAG = "</name>\n";
    string POINT_COORD_OPEN = "<Point><coordinates>";
    string POINT_COORD_CLOSE = "</coordinates></Point>\n";
